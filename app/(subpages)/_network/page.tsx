...
import { NETWORK_LINKS, OG_IMAGES } from "@/lib/utils/variables"
		...
		<Card>
			<header className="p-6 border-b">
				...
				<p className="text-black-10 dark:text-white-10">
					Um espaço para recomendar pessoas que são incríveis naquilo que elas
					se propõem a fazer.
				</p>
			</header>
			<div className="grid grid-cols-[repeat(auto-fit,minmax(10rem,1fr))] gap-4 p-6">
				{NETWORK_LINKS.map((company) => {
					return (
						<article key={company.name} className="flex gap-4 items-center">
							...
							<div className="flex-1 overflow-hidden">
								...
								<p className="text-black-10 dark:text-white-10 truncate">
									{company.workWith}
								</p>
								<Link
